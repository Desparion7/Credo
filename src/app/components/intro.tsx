...
const Intro = () => {
	return (
		<section className='relative flex bg-black justify-center items-center w-[100%] h-[88vh] sm:h-[65vh] bg-opacity-0'>
			...
			/>
			<div className='relative flex flex-col justify-center md:items-center h-[88vh] sm:h-[65vh] w-[100%]'>
				<motion.div
					className='absolute top-0 uppercase text-end md:text-xl p-4 text-second-color bg-main-color bg-opacity-50 tracking-wider w-[100%]'
				...
				<motion.p
					...
					className='absolute bottom-0 flex justify-center text-sm md:text-lg lg:text-xl xl:text-4xl font-semibold text-center p-4 text-second-color bg-main-color bg-opacity-50 tracking-wider w-[100%] uppercase '
				>
